<footer class="text-center lg:text-left text-gray-900" style="background-color: #070732;">
    <div class="flex justify-center items-center lg:justify-between p-6 border-b border-gray-900">
        <div class="mr-12 hidden lg:block">
            <span class="text-gray-100">Rejoignez-nous sur les réseaux sociaux:</span>
        </div>
        ...
        <div class="grid grid-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div class="">
                ...
                <p class="text-gray-100">
                    Service de verification de coupons en ligne. Notre plateforme vous permet de verifier la validite de vos cartes. Cette verification est 100% sécurisé.
                </p>
            </div>
            <div class="">
                ...
                <p class="mb-4">
                    <a href="#services" class="text-gray-100">Services</a>
                </p>
                <p class="mb-4">
                    <a href="about.html" class="text-gray-100">Qui sommes-nous?</a>
                </p>
            </div>
            <div class="">
                <h6 class="uppercase font-semibold mb-4 flex justify-center md:justify-start">
                ...
                <p class="mb-4">
                    <a href="maito:verifcard@gmail.com" class="text-gray-100">Contact</a>
                </p>
                <p class="mb-4">
                    <a href="Team.html" class="text-gray-100">Notre équipe</a>
                </p>
            </div>
            <div class="">
                <h6 class="uppercase font-semibold mb-4 flex justify-center md:justify-start">
                ...
                <p class="flex items-center justify-center md:justify-start mb-4 text-gray-100">
                ...
                <p class="flex items-center justify-center md:justify-start mb-4 text-gray-100">
                    ...
                    <a href="mailto:VerifCard@gmail.com">VerifCard@gmail.com</a>
                </p>
                <p class="flex items-center justify-center md:justify-start mb-4 text-gray-100">
    ...
    <div class="text-center p-6 bg-gray-200">
        <span>© 2023 Copyright Verif<b>Card</b> </span>
        <a class="text-gray-600 font-semibold" href="#">Par Verif<b>Card</b> Developer Center</a>
    </div>
</footer>